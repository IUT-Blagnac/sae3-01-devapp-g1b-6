...
<body>
	...
	<strong>- La date d'expiration </strong>est du format 'MM/AA', <br>pensez à renseigner le '/'.<br><br>
  <strong><em>Nous ne conservons pas vos informations de paiement <br>dans notre base de données. </em></strong><br></p>
	</div>
